...
const listBeatsHelp = runCli(['list-beats', '--help']);
const insertBeatHelp = runCli(['insert-beat', '--help']);
const lintTimelineHelp = runCli(['lint-timeline', '--help']);
...
expectIncludes(listBeatsHelp, '--schema <schema>', 'list-beats help');
expectIncludes(insertBeatHelp, '--time <seconds>', 'insert-beat help');
expectIncludes(insertBeatHelp, '--list', 'insert-beat help');
expectIncludes(lintTimelineHelp, '--json', 'lint-timeline help');
