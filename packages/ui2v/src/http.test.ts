...
describe("registryUrl", () => {
  it("preserves registry base paths and normalizes slashes", () => {
    expect(registryUrl("/api/v1/motions", "https://ui2v.com").toString()).toBe(
      "https://ui2v.com/api/v1/motions",
    );
    expect(registryUrl("/api/v1/motions", "http://localhost:8081/custom/path").toString()).toBe(
      "http://localhost:8081/custom/path/api/v1/motions",
    );
    expect(registryUrl("api/v1/motions", "http://localhost:8081/custom/path/").toString()).toBe(
      "http://localhost:8081/custom/path/api/v1/motions",
    );
