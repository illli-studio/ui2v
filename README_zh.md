...
这个 skill 放在 [`skills/ui2v`](skills/ui2v/SKILL.md)，会引导 AI 使用 ui2v 的完整动画项目能力：runtime 时间线、自定义代码、浏览器渲染、 three、d3、gsap、物理、粒子、字体、 Lottie/图标等 npm/内置库组合、 MP4 导出以及 README Showcase 素材打包。
